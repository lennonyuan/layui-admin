layui.config({
    ...
    function defineTable() {
        tableIns = table.render({
            elem: '#role-data'
            /*, height: 415*/
            , url:$tool.getContext() + '/supplier/pagelist' //数据接口
            , method: 'post'
            , page:true //开启分页
            , cols: [[ //表头
                  {type:'numbers',title:'序号',fixed: 'left'}
                , {field: 'id', title: '供应商ID', width: '10%'}
                , {field: 'supplierName', title: '供应商名称'/*,templet: '#tmp'*/}
                , {field: 'supplierDescribe', title: '供应商描述'}
                , {field: 'phone', title: '供应商手机'}
